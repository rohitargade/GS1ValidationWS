...
@XmlType(name = "TradeItemHandlingModuleType", namespace = "urn:gs1:gdsn:trade_item_handling:xsd:3", propOrder = {
    "tradeItemHandlingInformation"
})
@XmlRootElement(name = "tradeItemHandlingModule",namespace = "urn:gs1:gdsn:trade_item_handling:xsd:3")
