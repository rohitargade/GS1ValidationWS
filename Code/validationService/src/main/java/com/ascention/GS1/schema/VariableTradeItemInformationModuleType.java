...
@XmlType(name = "VariableTradeItemInformationModuleType", namespace = "urn:gs1:gdsn:variable_trade_item_information:xsd:3", propOrder = {
    "variableTradeItemInformation"
})
@XmlRootElement(name = "variableTradeItemInformationModule",namespace = "urn:gs1:gdsn:variable_trade_item_information:xsd:3")
