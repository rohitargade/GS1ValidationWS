...
@XmlType(name = "ReferencedFileDetailInformationModuleType", namespace = "urn:gs1:gdsn:referenced_file_detail_information:xsd:3", propOrder = {
    "referencedFileHeader"
})
@XmlRootElement(name = "referencedFileDetailInformationModule",namespace = "urn:gs1:gdsn:referenced_file_detail_information:xsd:3")
