...
@XmlType(name = "ProductCharacteristicsModuleType", namespace = "urn:gs1:gdsn:product_characteristics:xsd:3", propOrder = {
    "productCharacteristics"
})
@XmlRootElement(name = "productCharacteristicsModule",namespace = "urn:gs1:gdsn:product_characteristics:xsd:3")
