...
@XmlType(name = "DutyFeeTaxInformationModuleType", namespace = "urn:gs1:gdsn:duty_fee_tax_information:xsd:3", propOrder = {
    "dutyFeeTaxInformation"
})
@XmlRootElement(name = "dutyFeeTaxInformationModule",namespace = "urn:gs1:gdsn:duty_fee_tax_information:xsd:3")
