...
public interface TradeItemHierarchyDAO {
	public List<TradeItemHierarchy> getAllTradeItemHierarchy(Integer Product_Id, String strHierarchyIds, String strCOOIds, Integer Client_Id);
