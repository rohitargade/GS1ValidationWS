...
import com.ascention.validationWS.dao.HierarchyUNSPSCAttributesDAO;
import com.ascention.validationWS.dao.OrderQtyDAO;
import com.ascention.validationWS.dao.UNSPSCAttributesDAO;

@Repository
public class HierarchyUNSPSCAttributesRepository implements HierarchyUNSPSCAttributesDAO {

	    @Autowired 
	    private NamedParameterJdbcTemplate jdbcTemplate;
	 

		public List<HierarchyUNSPSCAttributes> getAllHierarchyUNSPSCAttributesForProduct(Integer Product_Id,
			...
			List<HierarchyUNSPSCAttributes> lstHierarchyUNSPSCAttributes = jdbcTemplate.query(sql, parameters, new BeanPropertyRowMapper(HierarchyUNSPSCAttributes.class));
