...
import com.ascention.validationWS.dao.HierarchyDutyDAO;
import com.ascention.validationWS.dao.OrderQtyDAO;

@Repository
public class HierarchyDutyRepository implements HierarchyDutyDAO {
		...
		public List<HierarchyDuty> getAllHierarchyDutyForProduct(Integer Product_Id, String strHierarchyIds,
			...
			String sql = "-- ARRAY - Duty\r\n" + 
					...
					"WHERE		PHD.[Product_Hierarchy_Id] IN ("+strHierarchyIds+")\r\n" + 
					"AND			PHD.[Is_Active] = 1;";

			List<HierarchyDuty> lstHierarchyDuty = jdbcTemplate.query(sql, parameters, new BeanPropertyRowMapper(HierarchyDuty.class));
